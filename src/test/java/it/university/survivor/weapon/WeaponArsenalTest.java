...
class WeaponArsenalTest {
    ...
    void automaticShouldStillTargetNearestEnemy() {
        ...
        ProjectileSpawnRequest request = weapon.attack(PLAYER, List.of(far, near)).get(0);
    ...
    void shotgunShouldProduceMultipleSpreadProjectiles() {
        ...
        List<ProjectileSpawnRequest> requests = weapon.attack(PLAYER, List.of(target));
    ...
    void sniperShouldPreferFarthestEnemyBeforeEvolution() {
        ...
        ProjectileSpawnRequest request = weapon.attack(PLAYER, List.of(near, far)).get(0);
    ...
    void pulseShouldFireAroundThePlayerWithoutTargets() {
        ...
        List<ProjectileSpawnRequest> requests = weapon.attack(PLAYER, List.of());
    ...
    void sniperEvolutionShouldChangeFromSingleTargetToBurst() {
        ...
        assertEquals(1, weapon.attack(PLAYER, List.of(first, second, third)).size());
        ...
        weapon.update(weapon.getCooldownRemaining());
        assertEquals(3, weapon.attack(PLAYER, List.of(first, second, third)).size());
    }
    ...
    void automaticEvolutionShouldIncreaseProjectilePattern() {
        ...
        assertEquals(1, weapon.attack(PLAYER, List.of(target)).size());
        ...
        weapon.update(weapon.getCooldownRemaining());
        assertEquals(3, weapon.attack(PLAYER, List.of(target)).size());
    }
    ...
    void pulseEvolutionShouldIncreaseRadialDensity() {
        ...
        assertEquals(12, weapon.attack(PLAYER, List.of()).size());
    }
}