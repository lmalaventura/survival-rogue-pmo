...
public final class UpgradeCatalog {
    ...
    private static List<Template> createDefaultTemplates() {
        return List.of(
                new Template(
                        "Cuore di Pietra",
                        new StatModifier(StatType.MAX_HEALTH, ModifierType.FLAT, 20.0)
                ),
                new Template(
                        "Armatura Vitalizzante",
                        new StatModifier(StatType.MAX_HEALTH, ModifierType.PERCENTAGE, 0.10)
                ),
                new Template(
                        "Modulo Potenza",
                ...
                new Template(
                        "Iniettore di Plasma",
                        new StatModifier(StatType.DAMAGE, ModifierType.PERCENTAGE, 0.08)
                ),
                new Template(
                        "Circuito Sovralimentato",
                        new StatModifier(StatType.COOLDOWN, ModifierType.PERCENTAGE, -0.10)
                ),
                new Template(
                ...
                new Template(
                        "Nucleo Sovraccarico",
                        new StatModifier(StatType.DAMAGE, ModifierType.FLAT, 12.0)
                ),
                new Template(
                        "Elisir del Titano",
                        new StatModifier(StatType.MAX_HEALTH, ModifierType.FLAT, 30.0)
                ),
                new Template(
                        "Sincronizzatore Temporale",
                        new StatModifier(StatType.COOLDOWN, ModifierType.PERCENTAGE, -0.15)
                )
        );
    }
}
